  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-5">
        <a
          className="flex items-center justify-center mt-5 border border-green-300 rounded-xl px-5 py-2"
        ...
        <a
          className="flex items-center justify-center mt-5 border border-green-300 rounded-xl px-5 py-2"
          href={'https://google.com/maps/search/' + name + address}
          target="_blank"
        >
          <div className="flex justify-center items-center relative text-green-300 w-5 h-5 me-3">
      ...
      <div className="grid grid-cols-12 w-full mt-10 bg-cyan-900 p-4 rounded-xl">
        ...
        <div className="col-span-1 text-green-300 flex items-center">
          <MdRemove className="w-5 h-5" />
        </div>
        <div className="col-span-8">Precio total:</div>
        <div className="col-span-3">${total}</div>
        <div className="col-span-1 text-green-300 flex items-center mt-3">
        ...
        <div className="col-span-1 text-green-300 flex items-center mt-5">
